    ...
    <div class="col-lg-8">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST"
                      action="index.php?page=mahasiswa&action=edit&id=<?= $mahasiswa['id'] ?>"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select <?= isset($errors['jurusan']) ? 'is-invalid' : '' ?>"
                                ...
                                <option value="Teknik Komputer" <?= $mahasiswa['jurusan'] === 'Teknik Komputer' ? 'selected' : '' ?>>
                                    Teknik Komputer
                                </option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select <?= isset($errors['semester']) ? 'is-invalid' : '' ?>"
                                ...
                                <?php for ($i = 1; $i <= 14; $i++): ?>
                                <option value="<?= $i ?>" <?= $mahasiswa['semester'] == $i ? 'selected' : '' ?>>
                                    Semester <?= $i ?>
                                </option>
                                <?php endfor; ?>
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control"
                                  ...
                                  name="alamat"
                                  rows="3"
                                  placeholder="Masukkan alamat lengkap"><?= e($mahasiswa['alamat']) ?></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div id="imagePreview" class="mt-3" style="display: none;">
                            <p class="text-muted mb-1">Foto baru:</p>
